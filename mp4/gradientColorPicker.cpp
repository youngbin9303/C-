 ...
 */
gradientColorPicker::gradientColorPicker(RGBAPixel fadeColor1, RGBAPixel fadeColor2,
...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
     ...
     */
     ...
     color.red = fadeColor1.red- floor(disTance*fadeColor1.red/radius)+floor(disTance*fadeColor2.red/radius);
     color.green = fadeColor1.green- floor(disTance*fadeColor1.green/radius)+floor(disTance*fadeColor2.green/radius);
     color.blue = fadeColor1.blue- floor(disTance*fadeColor1.blue/radius)+floor(disTance*fadeColor2.blue/radius);
     return color;
      }
      return fadeColor2;
}
